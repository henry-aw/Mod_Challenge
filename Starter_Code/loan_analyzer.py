...
print(f"All together, the loans have a total value of {total_value_of_loans}.")
...
print(f"The loan has a Future Value of {future_value}.")
...
for cost in loan_costs:
    if present_value >= cost:
        print(f"This loan is worth at least {cost}.")
    else:
        print(f"The loan is too expensive and not worth {cost}.")
